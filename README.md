...
## 🚦 מצבי מערכת והתרעה
המערכת מנהלת 5 מצבי סטטוס בזמן אמת, המחושבים על בסיס מיקומי ההתרעות הפעילות בארץ אל מול **"אזורי המעקב הממוקדים"** שהגדרת.
המערכת תמיד תציג את המצב החמור ביותר (המספר הגבוה ביותר) התקף לאזורים המוגדרים:

1. **מצב 0 (שגרה):** אין כל התרעה רלוונטית באזורי המעקב שלך, ואין שום שיגורים בקרבתך (האזורים הקרובים שמוגדרים ברדיוס המעקב נקיים).
2. **מצב 1 (ממתין לסיום אירוע):** הייתה אזעקה ממוקדת באחד מאזורי המעקב שלך בעשר הדקות האחרונות, אך היא חלפה מהמפה ונותר רק להמתין במרחב המוגן עד לאישור סופי לחזרה לשגרה.
3. **מצב 2 (עירני):** אין אזעקה ממשית בתוך אזור המעקב שלך, אך זוהה שיגור (או כטב"ם) באזור קרוב הנמצא **בתוך הרדיוס** (proximity_radius_km) שהוגדר. במצב זה המערכת מתריעה על איום קרוב אך מבלי לדרוש כניסה מידית לממ"ד (אלא אם פיקוד העורף מורה אחרת). במידה והאזעקה הקרובה מסתיימת – המערכת תחזור אוטומטית למצב "שגרה".
4. **מצב 3 (התרעה מוקדמת):** זוהה איום ארוך טווח המיועד באופן ישיר לאחד מאזורי המעקב שלך. זהו מצב בו ידוע שיש זמן התארגנות מורחב לפני הגעת האיום.
5. **מצב 4 (אזעקה מידית):** אזעקה פעילה של ירי תלול מסלול (טילים) או חדירת כלי טיס עוין מתקיימת ממש עכשיו **בתוך** אחד מאזורי המעקב שהגדרת. חובה להיכנס מיד למרחב מוגן.
